...
import 'package:account_book_vibe/features/invest/invest_viewmodel.dart';
...
class InvestCategoryScreen extends StatefulWidget {
  const InvestCategoryScreen({super.key});

  @override
  State<InvestCategoryScreen> createState() => _InvestCategoryScreenState();
}

class _InvestCategoryScreenState extends State<InvestCategoryScreen> {
  late final InvestViewModel _vm;
    ...
    return Card(
      ...
      child: ListTile(
        ...
        title: Row(
          children: [
            Expanded(
              child: Text(item.categoryNm, style: AppTextStyles.textBodyMd),
            ),
            Text(
